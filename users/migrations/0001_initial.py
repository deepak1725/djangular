# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-12-28 11:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_created=True, auto_now_add=True)),
                ('created', models.DateTimeField(auto_created=True, auto_now=True)),
                ('friend', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FriendChannel', to='users.FriendChannels')),
